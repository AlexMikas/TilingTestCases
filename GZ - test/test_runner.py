...
os.system("gcc -O3 -o src Gaus-Zeid.c")
if omp:
    os.system("gcc -O3 -fopenmp -o mod Gaus-Zeid-st+wf.c")
else:
    os.system("gcc -O3 -o mod Gaus-Zeid-st+wf.c")
    thread_count = 0
...
for th_c in range(6, thread_count+1, 6):
    ...
    for d1 in [4, 8, 16, 32,64]:
        for dn in [ 8, 16, 20, 25, 40, 50, 80,  100,  125,  200,  250,  400]:#sorted(FindAllDivisors(10000)): #list(range(2, 30 + 1, 1)): #(200,5000,50)
